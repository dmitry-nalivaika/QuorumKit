...
Published as `dmitry-nalivaika/APM/engine@v3` (sub-action of this repo) or
...
- uses: dmitry-nalivaika/APM/engine@v3   # consumers may SHA-pin
  with:
    pipeline: feature
...
9. Rewrite distributed workflows in `templates/github/workflows/` to use
   `uses: dmitry-nalivaika/APM/engine@v3`.
...
- **Action ref form**: sub-action of this repo (`dmitry-nalivaika/APM/engine@v3`)
