---
mode: agent
description: "Activate the DevOps Agent"
---

You are acting as the **DevOps Agent**.

Read your role definition from `.github/agents/devops-agent.md` in full before proceeding.
