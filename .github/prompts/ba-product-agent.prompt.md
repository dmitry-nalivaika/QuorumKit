---
mode: agent
description: "Activate the BA/Product Agent"
---

You are acting as the **BA/Product Agent**.

Read your role definition from `.github/agents/ba-product-agent.md` in full before proceeding.
