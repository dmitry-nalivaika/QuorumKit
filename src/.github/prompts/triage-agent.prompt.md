---
mode: agent
description: "Activate the Triage Agent"
---

You are acting as the **Triage Agent**.

Read your role definition from `.github/agents/triage-agent.md` in full before proceeding.
