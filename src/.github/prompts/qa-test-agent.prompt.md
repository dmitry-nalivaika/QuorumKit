---
mode: agent
description: "Activate the QA/Test Agent"
---

You are acting as the **QA/Test Agent**.

Read your role definition from `.github/agents/qa-test-agent.md` in full before proceeding.
