...
| ---------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- |
| `contents: read`       | required       | `actions/checkout` reads the consumer repo to load `src/pipelines/`, `.github/agents/`, and other SoT files.                              | never — without this the engine cannot start.                 |
